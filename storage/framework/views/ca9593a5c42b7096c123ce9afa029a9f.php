...
<body class="bg-gray-100">
        ...
        <div class="container mx-auto flex justify-between items-center">
            ...
            <?php if(auth()->guard()->check()): ?>
                <nav class="flex gap-2 items-center">
                    ...
                    <a class="fond-bold text-gray-600 text-sm" href="#">
                        Hola:
                    ...
                    <form method="POST" action="<?php echo e(route('logout')); ?>">
                        <?php echo csrf_field(); ?>
                        <button type="submit" class="fond-bold uppercase text-gray-600 text-sm">Cerrar Sesión</button>
                    </form>
                </nav>
            <?php endif; ?>
            <?php if(auth()->guard()->guest()): ?>
                <nav class="flex gap-2 iteams-center">
    ...
    <footer class="mt-10 text-center p-5 text-gray-500 fond-bold uppercase">
...
<?php /**PATH C:\Users\fabia\Desktop\devstagram\resources\views/layouts/app.blade.php ENDPATH**/ ?>